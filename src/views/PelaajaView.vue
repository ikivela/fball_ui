                      ...
                      <td>
                        <router-link
                          ...
                          :to="{
                            ...
                            query: {
                              season: ((match.season_id || match.season || '').split('-')[1] || (match.season_id || match.season)),
                              gameid: (match.match_id || match.UniqueID || match.gameid)
                            }
                          }"
                          class="text-primary"
                        ...
                        <span v-else class="text-primary" style="text-decoration:underline;">-</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
